@extends("layouts.main")
    ...
    @extends("layouts.navbar")
        ...
        <div class="row button_row">
            <div ><a href="/message/keyword_reply_message/create" class="create_compose_button_box">Create new</a></div>
        </div>
        <br>
        <div class="keyword_reply_tab">
                ...
                <button class="keyword_reply_tablinks" onclick="openCity(event, 'History')">History</button>
            </div>
                ...
                <div id="History" class="keyword_reply_tabcontent">
                    <table>
                        <tr>
                            <th>Main Keyword</th>
                            <th>Additional Keywords</th>
